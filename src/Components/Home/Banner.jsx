...
const Banner = () => {
  return (
    <div className="banner ">
      <h1 className="text-center font-bold lg:text-7xl text-3xl pt-5 lg:pt-[50px] gradient-text">
      ...
      <div className="flex flex-col lg:flex-row  lg:gap-4 gap-2 items-center justify-center lg:mt-8 mt-4">
        <img className="lg:w-[200px] w-[60%] cursor-pointer" src="/PlayStore.jpg" alt="" />
        <img className="lg:w-[200px] w-[60%] cursor-pointer" src="/appStore.jpg" alt="" />
      </div>
      <div className="">
