  ...
  return (
    <div className="app-details">
      <div className="flex lg:flex-row flex-col gap-8 lg:gap-10 h-auto lg:h-[290px]">
        <div className="w-[60%] h-full m-auto lg:w-[270px] bg-white flex justify-center items-center p-4 rounded-md shadow">
          <img src={image} alt="" className="rounded-md" />
        </div>
        {/* app info */}
        <div className="w-full flex flex-col justify-between">
          <h4 className="font-bold lg:text-3xl text-2xl mb-2 text-gray-700">{title}</h4>
          ...
          <div className="flex gap-0 lg:justify-start justify-between lg:gap-[80px]">
            <div className="flex flex-col gap-2">
              ...
              <p className="text-3xl font-bold text-gray-700">{downloads / 1000000}M</p>
            </div>
            <div className="flex flex-col gap-2">
              <img className="w-7" src="/icon-ratings.png" alt="" />
              <p className="text-sm text-gray-600">Average Ratings</p>
              <p className="text-3xl font-bold text-gray-700">{ratingAvg}</p>
            </div>
            <div className="flex flex-col gap-2">
              <img className="w-7" src="/icon-review.png" alt="" />
              <p className="text-sm text-gray-600">Total Reviews</p>
              <p className="text-3xl font-bold text-gray-700">{reviews / 1000}K</p>
            </div>
          </div>
          {/* install now btn */}
      ...
      <p className="h-10"></p>
      <hr className="text-gray-300 my-9" />
      <h2 className="text-2xl font-bold text-gray-700">Description</h2>
